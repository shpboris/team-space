package org.teamspace.deploy_common.constants;

public class DeployCommonConstants {
    public static final String AZURE_CLOUD_TYPE = "AZURE_CLOUD_TYPE";
    public static final String AWS_CLOUD_TYPE = "AWS_CLOUD_TYPE";
